...
export function createTintedSpritesheet(
  ...
  for (let i = 0; i < data.length; i += 4) {
    ...
    if (r === SOURCE_COLORS.body.r && g === SOURCE_COLORS.body.g && b === SOURCE_COLORS.body.b) {
      data[i] = targetBody.r; data[i + 1] = targetBody.g; data[i + 2] = targetBody.b;
    } else if (r === SOURCE_COLORS.eye.r && g === SOURCE_COLORS.eye.g && b === SOURCE_COLORS.eye.b) {
      data[i] = targetEye.r; data[i + 1] = targetEye.g; data[i + 2] = targetEye.b;
    } else if (r === SOURCE_COLORS.foot.r && g === SOURCE_COLORS.foot.g && b === SOURCE_COLORS.foot.b) {
      data[i] = targetFoot.r; data[i + 1] = targetFoot.g; data[i + 2] = targetFoot.b;
    }
  }
